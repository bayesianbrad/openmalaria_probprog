...
\pgfplotsset{width=9.5cm,compat=1.5}
\begin{document}
...
and practitioners to make decisions from simulator outputs that can be fully resoned on.
...
\end{axis}
\caption{Trace probabilities. Trace 1 corresponds to A1,A1,A1,...,A4,... Trace 2 corresponds to A1,A1,A1,...A2,... These still need correctly calculating.}
\end{tikzpicture}
