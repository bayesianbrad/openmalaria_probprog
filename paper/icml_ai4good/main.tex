...
can mean they are difficult to work with and extract the key information
required by policy makers.
In this paper, we introduce an approach to \emph{hijack} these
simulators with an external
probabilistic programming system (PPS) that controls
their internal random number generator.
