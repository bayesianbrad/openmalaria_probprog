...
% \icmlauthor{Bradley.~J Gram-Hansen}{equal,en}
% \icmlauthor{Christian Schroeder de Witt}{equal,en}
% \icmlauthor{Tom Rainforth}{st}
% \icmlauthor{Phil H.S. Torr}{eng}
% \icmlauthor{Yee Whye Teh}{st}
% \icmlauthor{At\i{}l\i{}m G\"{u}ne\c{s} Baydin}{eng}
% \end{icmlauthorlist}




% \icmlcorrespondingauthor{Bradley.~J Gram-Hansen}{bradley@robots.ox.ac.uk}
% \icmlcorrespondingauthor{Eee Pppp}{ep@eden.co.uk}
\icmlsetsymbol{equal}{*}

\begin{icmlauthorlist}
\icmlauthor{Bradley.~J Gram-Hansen}{equal,en}
\icmlauthor{Christian Schr\"{o}der de Witt}{equal,en}
\icmlauthor{Tom Rainforth}{st}
\icmlauthor{Phil H.S. Torr}{en}
\icmlauthor{Yee Whye Teh}{st}
\icmlauthor{At\i{}l\i{}m G\"{u}ne\c{s} Baydin}{en}
\end{icmlauthorlist}
...
\icmlaffiliation{en}{Department of Engineering, University of Oxford, UK}
\icmlaffiliation{st}{Department of Statistics, University of Oxford, UK}
