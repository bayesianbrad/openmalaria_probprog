...
In this paper, we introduce an approach that allows one to treat a large class of population-based epidemiology simulators as probabilistic generative models. This is achieved by \emph{hijacking} the internal random number generator calls, using only minimal changes to pre-existing simulators, through the use of an universal probabilistic programming system (PPS). 
