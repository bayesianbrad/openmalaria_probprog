...
\section{Density estimation using Normalising flows}
...
environemnt, where there exists rejection sampling loops. 

We start by noting that the prior, defined in the context of the outter samples is 
defined as: 
\begin{equation}
  p(x) = 
  \begin{cases}
