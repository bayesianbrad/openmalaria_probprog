...
\begin{abstract}
  ...
  In this work we devleop both a formalism and framework for amortizing sub-programs
  in simulators leveraging state-of-the-art variational inference techniques.
  ...
  and hard, or expensive, to observe scenarios.
   These may represent a set of events, or a population of interacting agents. 
