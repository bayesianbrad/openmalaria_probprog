...
expectation equal to infinity. \textbf{Bradley: Is this true?}
...
task to do, because rejection sampling blocks within simulators are not necessarily written in a standard template such as R1 and R2. 
...
\subsection{Method 1: Learn the}
$\gamma_{a_{j}}(\cdot ; \eta_{a_{j}}, \cdot)$
...
If you minimise an $L_2$ norm the optimal 
