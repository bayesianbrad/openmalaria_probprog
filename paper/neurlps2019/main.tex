...
The \emph{model}, or equivalently \emph{program}, specified by the simulator defines a joint density $p(x,y)$ and the inputs into the simulator denote priors, $p(x)$. 

 def that are difficult to generate represent a large class of generative models, where the simulator itself represents a joint density
$p(x|y)$  arise in many industrial
