...
Probabilistic programming\cite{gordon2014probabilistic} is paradigm that enables users to write models in a programmatic way. 
The source code is then transformed into a program density, representing a joint density.
By having direct access to the source code enables Probabilistic Programming Systems~(PPS)
to analyse the model code in unique way, enabling posterior inference
to be performed in an automated way, which makes PPSs flexible and adaptive.
