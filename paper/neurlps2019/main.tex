...
\title{Hijacking Population-Based Simulators}
...
operations within a probabilistic programming system~(PPS) in an automated way,
such as analysing the model code, to perform statistically correct inference \cite{gram2018hamiltonian,goodman2012church,wood2014new}.
